...
try {
    ...
    // 1. Unique Time Engine Injection (Using auctionTick instead of currentTime)
  ...
  const formatTimeLeft = (endTime) => {
    ...
    // 2. Swap the static 'AUCTION' badge (Using auctionTick & TS Bypass)
    ...
    console.log("✅ UI UPGRADED: Unique Timer Engine & Ratings Injected.");
} catch(e) { 
