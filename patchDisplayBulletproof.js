...
try {
    ...
    // 1. Bulletproof Time Engine Injection
  ...
  const formatTimeLeft = (endTime) => {
    ...
    console.log("✅ UI UPGRADED: Bulletproof Type-Safe Timer Injected.");
} catch(e) { 
